...
extern int stb_vorbis_decode_filename(char *filename, int *channels, int *frequency, short **output);
#endif
extern int stb_vorbis_decode_memory(unsigned char *mem, int len, int *channels, int *frequency, short **output);
